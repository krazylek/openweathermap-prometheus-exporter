...
function getMetrics(json) {
  return dedent`
    ...
    weather_temperature_kelvin{name="${json.name}",type="current"} ${json.main.temp}
    weather_temperature_kelvin{name="${json.name}",type="max"} ${json.main.temp_max}
    weather_temperature_kelvin{name="${json.name}",type="min"} ${json.main.temp_min}
    ...
    ${json.main.grnd_level ? `weather_pressure_hectopascal{name="${json.name}",level="ground"} ${json.main.grnd_level}` : ''}
    ${json.main.sea_level ? `weather_pressure_hectopascal{name="${json.name}",level="sea"} ${json.main.sea_level}` : ''}
  `
}
